<script setup lang="ts">
  ...
  const activeTabComponent = computed(() => {
    const { mode: propsMode, chromeClass, buttonClass, sliderClass } = props
    const mode = propsMode as PageTabMode

    const tabComponentMap: Record<PageTabMode, { component: Component; class?: string }> = {
      chrome: {
        component: ChromeTab,
        class: chromeClass,
      },
