...
import type { PaginationData, TableColumnCheck, UseTableOptions } from "@monorepo-example/hooks"
import { useBoolean, useTable } from "@monorepo-example/hooks"
import type { FlatResponseData } from "@monorepo-example/axios"
...
export interface UseTableOperateReturn<TableData> {
...
): UseTableOperateReturn<TableData> {
